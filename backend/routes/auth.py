...
from auth import CompanyResponse, LoginRequest, Token, TokenData, create_access_token, verify_password
from config import is_admin_company_code
from database import get_db
from dependencies import get_admin_user, get_current_user
import models
from services.camera_service import ensure_company_cameras_started, stop_company_cameras
...
async def select_company_for_admin(
    ...
    """Admin company sectiginde ilgili sirketin kamera thread'lerini baslatir."""
    company_result = await db.execute(
